...
var $author$project$Model$PostIds$advance = function (_v0) {
	...
	if (_v1.$ === 'Just') {
		...
		return $elm$core$Maybe$Just(
			_Utils_Tuple2(
				$author$project$Cursor$current(cursor),
				$author$project$Model$PostIds$PostIds(cursor)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
				...
				return _Utils_update(
					config,
					{
						postsToShow: A2(
							$elm$core$Maybe$withDefault,
							config.postsToShow,
							$elm$core$String$toInt(newPostsToShow))
					});
			case 'ChangeSortBy':
...
var $author$project$Util$Time$durationBetween = F2(
	function (t1, t2) {
		var toDuration = function (totalMillis) {
			var seconds = A2($elm$core$Basics$modBy, 60, (totalMillis / 1000) | 0);
			var minutes = A2($elm$core$Basics$modBy, 60, (totalMillis / (1000 * 60)) | 0);
			var hours = A2($elm$core$Basics$modBy, 24, (totalMillis / ((1000 * 60) * 60)) | 0);
			var days = (totalMillis / (((1000 * 60) * 60) * 24)) | 0;
			return {days: days, hours: hours, minutes: minutes, seconds: seconds};
		};
		var millisDiff = $elm$time$Time$posixToMillis(t2) - $elm$time$Time$posixToMillis(t1);
		return (millisDiff > 0) ? $elm$core$Maybe$Just(
			toDuration(millisDiff)) : $elm$core$Maybe$Nothing;
	});
...
var $author$project$Util$Time$formatDuration = function (duration) {
	...
	var builderComponent = F2(
		function (n, unit) {
			return (!unit) ? '' : ($elm$core$String$fromInt(unit) + (' ' + (A2(toPlural, n, unit) + ' ')));
		});
	var dayFrag = A2(builderComponent, 'day', duration.days);
	var hourFrag = A2(builderComponent, 'hour', duration.hours);
	var minuteFrag = A2(builderComponent, 'minute', duration.minutes);
	var secondFrag = A2(builderComponent, 'second', duration.seconds);
	var frags = A2(
		$elm$core$List$filter,
		$elm$core$Basics$lt(''),
		_List_fromArray(
			[dayFrag, hourFrag, minuteFrag, secondFrag]));
	var formattedString = function () {
		if (!frags.b) {
			...
			if (!frags.b.b) {
				...
				return A2($elm$core$String$join, '', frags) + 'ago';
			}
		}
	}();
...
var $author$project$View$Posts$maybeStringToString = function (maybeString) {
	if (maybeString.$ === 'Just') {
	...
	function (currentTime, post) {
		...
		var linkAttributes = _List_fromArray(
			[
				...
				$author$project$View$Posts$maybeStringToString(post.url)),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(formattedTime + (' (' + (postDuration + ')')))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
...
var $author$project$Model$PostsConfig$ToggleShowJobPosts = function (a) {
	return {$: 'ToggleShowJobPosts', a: a};
};
var $author$project$Model$PostsConfig$ToggleShowTextOnlyPosts = function (a) {
	return {$: 'ToggleShowTextOnlyPosts', a: a};
};
					...
					[
						...
						function (x) {
							return $author$project$Model$ConfigChanged(
								$author$project$Model$PostsConfig$ChangePostsToShow(x));
						})
					]),
				_List_fromArray(
					[
					...
					[
						...
						_List_fromArray(
							[
								...
								function (x) {
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$ToggleShowJobPosts(x));
								}),
					...
					[
						...
						_List_fromArray(
							[
								...
								function (x) {
									return $author$project$Model$ConfigChanged(
										$author$project$Model$PostsConfig$ToggleShowTextOnlyPosts(x));
								}),
		...
		var filteredPosts = A2(
			...
			A2(
				...
				A2(
					$elm$core$List$filter,
					function (post) {
						return (config.showJobs && (post.type_ === 'job')) || config.showJobs;
					},
					A2(
						$elm$core$List$filter,
						function (post) {
							return (config.showTextOnly && (!_Utils_eq(post.url, $elm$core$Maybe$Nothing))) || config.showTextOnly;
						},
						posts))));
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\ExampleTests\\CursorTests.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\ExampleTests\\ModelPostIdsTests.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\ExampleTests\\ModelPostsConfigTests.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\ExampleTests\\UtilTimeTests.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\MainTests.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\PostsConfigTests.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\PostsViewTests.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\PostTests.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\SimulatedEffect.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\TestData.elm', 'C:\\Users\\Andrei Eminovici\\Desktop\\FP\\Elm_Project\\tests\\TestUtils.elm']),
		processes: 8,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-23452-1";
var net = require('net'),
