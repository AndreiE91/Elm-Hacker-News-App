...
postsConfigView config =
    div []
        ...
        , select [ id "select-posts-per-page", onInput (\x -> ConfigChanged (ChangePostsToShow x)) ]
        ...
        , label [ for "checkbox-show-job-posts" ] [ input [ id "checkbox-show-job-posts", type_ "checkbox", onCheck (\x -> ConfigChanged (ToggleShowJobPosts x)), checked config.showJobs ] [], text " Show Job Posts" ]
        
        , label [ for "checkbox-show-text-only-posts" ] [ input [ id "checkbox-show-text-only-posts", type_ "checkbox", onCheck (\x -> ConfigChanged (ToggleShowTextOnlyPosts x)), checked config.showTextOnly ] [], text " Show Text" ]
    ]
